...
from dataviewer.io.database import DB
from dataviewer.io.selection import Selection
from dataviewer.ui.helper.share import share_content, get_qr_code
...
def tabs():
    return (
        ui.tabs()
        .classes(
            "bg-secondary text-gray-200 h-[56px] w-full scroll font-bold subpixel-antialiased tracking-widest m-0 p-0"
        )
