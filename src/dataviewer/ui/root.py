...
from dataviewer.ui.sub_pages.category import category_page
from dataviewer.ui.sub_pages.finish import finish_page
from dataviewer.ui.sub_pages.form import form_page
from dataviewer.ui.sub_pages.help import help_page
from dataviewer.ui.sub_pages.start import start_page
...
def root(
    ...
    sub_pages.add(f"/{WAREHOUSE_ROOT}", lambda: category_page(warehouses[0].name, warehouses[0]))
